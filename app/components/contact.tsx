      ...
      <div className="container mx-auto">
        ...
        >
          <CardBody 
            ...
            onPointerEnterCapture={() => {}}
            onPointerLeaveCapture={() => {}}
            className="grid grid-cols-1 md:p-10 lg:grid-cols-2 md:gap-28"
          >
            ...
            <div className="w-full rounded-lg h-full py-8 p-5 md:p-16 gradient">
              <Typography 
                variant="h4" 
                color="white" 
                className="mb-2"      
              ...
              <Typography
                variant="lead"
                className="mx-auto mb-8 text-base"
                color="white"
                placeholder="" 
                onPointerEnterCapture={() => {}}
                onPointerLeaveCapture={() => {}}
              ...
              <div className="flex items-center gap-5">
                <ul className="mx-auto grid grid-cols-4 gap-7">
                  <li>
                    <a href="#">
